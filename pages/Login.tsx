        ...
        <div className="flex min-h-screen items-center justify-center bg-app-bg-secondary p-4">
            <div className="w-full max-w-md space-y-8 rounded-2xl bg-app-bg-surface p-8 shadow-xl border border-app-border">
                <div className="text-center flex flex-col items-center">
                    ...
                    <h2 className="text-3xl font-black italic tracking-tight text-app-text-title">Primados que valen de oro</h2>
                    <p className="mt-2 text-sm text-app-text-body">Ingresa a tu cuenta para continuar</p>
                </div>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-end">
                            <Link to="/forgot-password" className="text-sm font-medium text-brand hover:text-brand-hover transition-colors">
                ...
                <div className="text-center text-sm">
                    <span className="text-app-text-body">¿No tienes cuenta? </span>
                    <Link to="/register" className="font-bold text-brand hover:text-brand-hover transition-colors">Regístrate aquí</Link>
                </div>
